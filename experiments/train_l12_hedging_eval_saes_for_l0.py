...
WIDTHS = [8192]
SEEDS = [0, 1, 2, 3]
L1S = [5.0, 7.5, 10.0, 20.0, 40.0]

BASE_PATH = "/home/dev/project-storage/saes/paper/hedging-l0s/gemma-2-2b/layer-12"
    ...
    for l1 in L1S:
        for seed in SEEDS:
            ...
            script_configs.append(
                TrainHedgingEvalSaelensSaeOptions(
                    base_sae_cfg=cfg,
                    base_output_path=f"{BASE_PATH}/l1-{l1}/width-{width}/seed-{seed}",
